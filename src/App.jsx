...
// --- DATA (Linked to your clean local filenames) ---
const lookbook = [
  { id: 1, title: "Urban Solitude", image: "/obsidian-black.jpg", product: { name: "Obsidian Black", price: 25 } },
  { id: 2, title: "Concrete Textures", image: "/charcoal-grey.jpg", product: { name: "Engineered Charcoal", price: 25 } },
  { id: 3, title: "Natural Light", image: "/bone-white.jpg", product: { name: "Bone Off-White", price: 25 } }
];

const products = [
  { id: 1, name: "Obsidian Black", price: 25, stock: "04/10", image: "/obsidian-black.jpg", description: "Deep matte black finish. 260GSM heavyweight cotton. Pre-shrunk and engineered for the perfect drape." },
  { id: 2, name: "Bone Off-White", price: 25, stock: "03/10", image: "/bone-white.jpg", description: "Natural unbleached tone. 260GSM heavyweight cotton. Soft hand-feel with structural integrity." },
    ...
    <>
      <section className="relative h-[100svh] w-full flex flex-col items-center justify-center overflow-hidden">
          <div className="absolute inset-0 z-0 overflow-hidden bg-black">
            ...
            <img src="/hero-image.jpg" alt="Hero" className="w-full h-full object-cover scale-105 opacity-50 grayscale" />
          </div>
